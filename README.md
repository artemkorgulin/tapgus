...
4. После авторизации стартует игра, и появляется наш "известный персонаж" Гусь! :) \
   ![img_3.png](img_3.png)
   Счётчик очков внизу под каждого пользователя, время не показывается визуально, но учитывается.
5. 
