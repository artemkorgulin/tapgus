import type { IBaseListItem, IListBlockItemRounds } from 'api/api.v2.types';
import cn from 'clsx';
...
export interface IListBlockItemRoundsProps
    extends IBaseListItem,
        IListBlockItemRounds {
    hoverContent: ReactElement;
    hasAchivs?: boolean;
}

export const ListBlockItemRounds: TComponent<IListBlockItemRoundsProps> = ({
    id,
    avatar,
    accent,
    name,
