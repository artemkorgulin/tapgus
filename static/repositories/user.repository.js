...
var UserRepository = /** @class */ (function () {
    ...
    UserRepository.prototype.findAll = function (query) {
        return __awaiter(this, void 0, void 0, function () {
            var queryBuilder;
            return __generator(this, function (_a) {
                queryBuilder = this.userRepository.createQueryBuilder('user');
                if (query === null || query === void 0 ? void 0 : query.search) {
                    queryBuilder.where('user.name LIKE :search OR user.email LIKE :search', { search: "%".concat(query.search, "%") });
                }
    ...
    UserRepository.prototype.findById = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.userRepository.findOneById(id)];
            });
        });
    };
    UserRepository.prototype.findByEmail = function (email) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.userRepository.findOne({ where: { email: email } })];
            });
        });
    };
    ...
    UserRepository.prototype.update = function (user, updateData) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    UserRepository.prototype.delete = function (user) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.userRepository.remove(user)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    UserRepository.prototype.count = function (query) {
        return __awaiter(this, void 0, void 0, function () {
            var queryBuilder;
            return __generator(this, function (_a) {
                queryBuilder = this.userRepository.createQueryBuilder('user');
                ...
                return [2 /*return*/, queryBuilder.getCount()];
            });
        });
    };
