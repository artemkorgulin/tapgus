...
| VITE_USE_IFRAMES                   | ENV_USE_IFRAMES                   | on/off глобальное использование iframe-контента               | Используется в `HOC` `WithIframe` для оборачивания всех не закрнченных страниц.                                                           |
...
| карта связей  | Карта связей роутов в React и Bitrix |
